            ...
            <table class="table table-striped ms-5 a" style="width: 100%;">
                ...
                <tbody>
                    <tr v-for="row in rows" :key="row.id" class="align-middle">
                        ...
                        <td class="text-end">
                            <button class="btn text-primary me-3"
                                @click="$emit('edit', { id: row.id, name: row.name })"> <square-pen></square-pen>
                            </button>
                            <button class="btn text-danger" @click="$emit('delete', { id: row.id, name: row.name })">
                                <trash2></trash2>
                            </button>
                        </td>
                    </tr>
